package net.auberson.awsddns.model;
/*
 * Copied from https://github.com/awslabs/aws-apigateway-lambda-authorizer-blueprints
 */
...
public class AuthPolicy {
	...
	public static class PolicyDocument {
		...
		/**
		 * Creates a new PolicyDocument with the given context, and initializes two base
		 * Statement objects for allowing and denying access to API Gateway methods
		 *
		 * @param region
		...
		/**
		 * Generates a new PolicyDocument with a single statement that allows the
		 * requested method/resourcePath
		 *
		 * @param region
		 *            API Gateway region
		 * @param awsAccountId
		...
		/**
		 * Generates a new PolicyDocument with a single statement that denies the
		 * requested method/resourcePath
		 *
		 * @param region
		 *            API Gateway region
